...
class ConfigCoverageResult:
    ...
    critical_undocumented: List[ConfigArtifact] = field(default_factory=list)  # Sensitive/required but undocumented
...
class ConfigCoverageCalculator:
    ...
    def calculate_coverage(self, project_path: str) -> ConfigCoverageResult:
        ...
        critical_undocumented = [
            ...
            if c.is_sensitive or c.type == 'connection_string'
        ]
