...
class DocumentationCoverage:
    ...
    def measure(self, extracted_docs: Dict) -> CoverageResult:
        ...
        for dim_name, dim_spec in self.spec.dimensions.items():
            ...
            dimension_score = (
                element_coverage * 0.3 + completeness_coverage * 0.4 + usefulness_coverage * 0.3
            )
        ...
        overall_coverage = sum(
            dimension_scores.get(dim, 0) * spec.weight for dim, spec in self.spec.dimensions.items()
        )
