...
from cli import assert_coverage, cli, demo, measure, measure_artifacts
...
class TestCLICommands:
    ...
    def test_measure_with_output_file(self, runner, temp_project):
        ...
        try:
            result = runner.invoke(measure, [str(temp_project), "--output", output_file])
    ...
    def test_measure_verbose(self, runner, temp_project):
        ...
        result = runner.invoke(measure, [str(temp_project), "--verbose"])
    ...
    def test_assert_coverage_custom_threshold(self, runner, temp_project):
        ...
        result = runner.invoke(assert_coverage, [str(temp_project), "--min-coverage", "0.95"])
...
'''
    ...
    def test_measure_artifacts_with_output(self, runner, temp_project):
        ...
        try:
            result = runner.invoke(measure_artifacts, [str(temp_project), "--output", output_file])
...
"""
        ...
        result = runner.invoke(measure_artifacts, [str(temp_project), "--min-coverage", "90"])
